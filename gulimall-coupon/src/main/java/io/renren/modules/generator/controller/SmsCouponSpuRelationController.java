 ...
 */
@RestController
@RequestMapping("generator/smscouponspurelation")
public class SmsCouponSpuRelationController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("generator:smscouponspurelation:list")
    ...
    @RequiresPermissions("generator:smscouponspurelation:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("generator:smscouponspurelation:save")
    ...
    @RequiresPermissions("generator:smscouponspurelation:update")
    ...
    @RequiresPermissions("generator:smscouponspurelation:delete")
