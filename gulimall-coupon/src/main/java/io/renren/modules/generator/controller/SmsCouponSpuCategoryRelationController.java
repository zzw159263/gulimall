...
import io.renren.modules.generator.entity.SmsCouponSpuCategoryRelationEntity;
import io.renren.modules.generator.service.SmsCouponSpuCategoryRelationService;
 ...
 */
@RestController
@RequestMapping("generator/smscouponspucategoryrelation")
public class SmsCouponSpuCategoryRelationController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("generator:smscouponspucategoryrelation:list")
    ...
    @RequiresPermissions("generator:smscouponspucategoryrelation:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("generator:smscouponspucategoryrelation:save")
    ...
    @RequiresPermissions("generator:smscouponspucategoryrelation:update")
    ...
    @RequiresPermissions("generator:smscouponspucategoryrelation:delete")
