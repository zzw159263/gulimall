...
import com.itguigu.gulimall.coupon.service.SmsSeckillSkuRelationService;
 ...
 */
@RestController
@RequestMapping("generator/smsseckillskurelation")
public class SmsSeckillSkuRelationController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("generator:smsseckillskurelation:list")
    ...
    @RequiresPermissions("generator:smsseckillskurelation:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("generator:smsseckillskurelation:save")
    ...
    @RequiresPermissions("generator:smsseckillskurelation:update")
    ...
    @RequiresPermissions("generator:smsseckillskurelation:delete")
