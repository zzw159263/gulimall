 ...
 */
@RestController
@RequestMapping("generator/smsskufullreduction")
public class SmsSkuFullReductionController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("generator:smsskufullreduction:list")
    ...
    @RequiresPermissions("generator:smsskufullreduction:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("generator:smsskufullreduction:save")
    ...
    @RequiresPermissions("generator:smsskufullreduction:update")
    ...
    @RequiresPermissions("generator:smsskufullreduction:delete")
